...
\tightlist
\item[{\hyperref[acronyms_H0]{H0}:}]
Defect rate is \textless{} 2 percent
\item[{\hyperref[acronyms_Ha]{Ha}:}]
Defect rate is \textgreater2 percent
\end{description}
...
\includegraphics[width=1.86in,height=\textheight,keepaspectratio]{chapter005/mm_doe_02.png}
