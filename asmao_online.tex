...
\pandocbounded{\includegraphics[keepaspectratio]{chapter001_Distributions_files/figure-pdf/unnamed-chunk-18-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{chapter001_Distributions_files/figure-pdf/unnamed-chunk-19-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter001_Distributions_files/figure-pdf/unnamed-chunk-25-1.pdf}}
...
\subsubsection{Simple random sampling - comparison to population
(mean)}\label{simple-random-sampling---comparison-to-population-mean}
...
\subsubsection{Simple random sampling - comparison to population
(sd)}\label{simple-random-sampling---comparison-to-population-sd}
...
\subsubsection{Systemtic sampling - comparison to population
(mean)}\label{systemtic-sampling---comparison-to-population-mean}
...
\subsubsection{Systemtic sampling - comparison to population
(sd)}\label{systemtic-sampling---comparison-to-population-sd}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stratified\_prop\_n5 }\OtherTok{\textless{}{-}}\NormalTok{ student\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{sample\_frac}\NormalTok{(}\FloatTok{0.12}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# Sample 30\% from each gender}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{stratified\_prop\_n10 }\OtherTok{\textless{}{-}}\NormalTok{ student\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{sample\_frac}\NormalTok{(}\FloatTok{0.25}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# Sample 30\% from each gender}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{stratified\_prop\_n15 }\OtherTok{\textless{}{-}}\NormalTok{ student\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{sample\_frac}\NormalTok{(}\FloatTok{0.38}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# Sample 30\% from each gender}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{stratified\_prop\_n20 }\OtherTok{\textless{}{-}}\NormalTok{ student\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{sample\_frac}\NormalTok{(}\FloatTok{0.50}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# Sample 30\% from each gender}
  \FunctionTok{ungroup}\NormalTok{()}

\NormalTok{strtsmpl }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{smpl\_type =} \StringTok{"stratified sampling"}\NormalTok{,}
  \AttributeTok{n =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{,}\DecValTok{15}\NormalTok{,}\DecValTok{20}\NormalTok{),}
  \AttributeTok{prop =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.12}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.38}\NormalTok{,}\FloatTok{0.5}\NormalTok{),}
  \AttributeTok{means =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{mean}\NormalTok{(stratified\_prop\_n5}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{mean}\NormalTok{(stratified\_prop\_n10}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{mean}\NormalTok{(stratified\_prop\_n15}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{mean}\NormalTok{(stratified\_prop\_n20}\SpecialCharTok{$}\NormalTok{Age)}
\NormalTok{  ),}
  \AttributeTok{sds =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{sd}\NormalTok{(stratified\_prop\_n5}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{sd}\NormalTok{(stratified\_prop\_n10}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{sd}\NormalTok{(stratified\_prop\_n15}\SpecialCharTok{$}\NormalTok{Age),}
    \FunctionTok{sd}\NormalTok{(stratified\_prop\_n20}\SpecialCharTok{$}\NormalTok{Age)}
\NormalTok{  )}
\NormalTok{) }

\NormalTok{strtsmpl }\OtherTok{\textless{}{-}}\NormalTok{ strtsmpl}\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{diff\_means =} \FunctionTok{mean}\NormalTok{(student\_data}\SpecialCharTok{$}\NormalTok{Age)}\SpecialCharTok{{-}}\NormalTok{means,}
    \AttributeTok{diff\_sds =} \FunctionTok{sd}\NormalTok{(student\_data}\SpecialCharTok{$}\NormalTok{Age) }\SpecialCharTok{{-}}\NormalTok{ sds}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Stratified sampling - comparison to population
(mean)}\label{stratified-sampling---comparison-to-population-mean}
...
\subsubsection{Stratified sampling - comparison to population
(sd)}\label{stratified-sampling---comparison-to-population-sd}
...
\caption{\label{tbl-starwarsdata-clust}The starwars dataset with
clustered sampling}
...
\begin{verbatim}
 ...
 Length:12          Min.   : 94.0   Min.   : 40   Length:12         
 Class :character   1st Qu.:150.5   1st Qu.: 48   Class :character  
 Mode  :character   Median :169.0   Median : 55   Mode  :character  
                    Mean   :159.2   Mean   : 63                     
                    3rd Qu.:179.2   3rd Qu.: 79                     
                    Max.   :198.0   Max.   :102                     
                                    NA's   :3                       
 ...
 Length:12          Length:12          Min.   :54.00   Length:12         
...
\setlength\LTright{0\linewidth}\fontsize{15.0pt}{18.0pt}\selectfont
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter002_InferentialStatistics_files/figure-pdf/unnamed-chunk-68-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter002_InferentialStatistics_files/figure-pdf/unnamed-chunk-71-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{chapter002_InferentialStatistics_files/figure-pdf/unnamed-chunk-72-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-36-1.pdf}}

\subsubsection{Precision}\label{precision-1}

\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-37-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-38-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-39-1.pdf}}

\subsubsection{F1 Score, harmonic mean of precision and
recall}\label{f1-score-harmonic-mean-of-precision-and-recall}

\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-40-1.pdf}}

\subsubsection{Receiver Operator Curve
(ROC)}\label{receiver-operator-curve-roc}

\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-41-1.pdf}}

\subsubsection{METRICSSS!!!!!}\label{metricsss}

\pandocbounded{\includegraphics[keepaspectratio]{chapter003_Regression_files/figure-pdf/unnamed-chunk-42-1.pdf}}
...
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{chapter004_ProductionStatistics_files/figure-pdf/unnamed-chunk-48-1.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{chapter004_ProductionStatistics_files/figure-pdf/unnamed-chunk-48-2.pdf}}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{chapter004_ProductionStatistics_files/figure-pdf/unnamed-chunk-48-3.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{chapter004_ProductionStatistics_files/figure-pdf/unnamed-chunk-48-4.pdf}}\end{minipage}%
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter005_DoE_files/figure-pdf/unnamed-chunk-20-1.pdf}}

\subsection{check residuals}\label{check-residuals}

\pandocbounded{\includegraphics[keepaspectratio]{chapter005_DoE_files/figure-pdf/unnamed-chunk-21-1.pdf}}
